import { IOneTimeToken, IPerformSearch, StreamSettings } from 'src/interfaces';
...
class StreamService extends APIRequest {
  search(query?: IPerformSearch) {
    return this.get(this.buildUrl('/streams/categories', query as any));
  }
  ...
  goLive(options?: any) {
    return this.post('/streaming/live', options);
  }
