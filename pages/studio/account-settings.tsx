...
import {
  ICountries, IUpdatePasswordFormData, IStudio, PAYMENT_ACCOUNT
} from 'src/interfaces';
...
class StudioProfilePage extends PureComponent<P, S> {
  ...
  render() {
    const {
      action, updating, studio, countries, t
    } = this.props;
...
export default connect(mapStates, mapDispatch)(withTranslation('common')(StudioProfilePage));
