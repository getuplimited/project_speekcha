  ...
  render() {
    ...
    return (
      <>
        ...
        {error && <Alert type="error" message={t('Error request')} banner />}
        {success && (
          <div className="videos-page">
            {query.username && !performer && (
              <Alert message={t('Performer not found')} banner />
            )}
            <InfiniteScroll
...
export default withRouter(
  connect(mapStateToProps, mapDispatchs)(withTranslation('common')(VideosPage))
);
